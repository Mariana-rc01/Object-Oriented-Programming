...
public class Corrida extends Atividade implements FazMetros{
    ...
    public int totalPointsPerMeter(){
        return 10;
    }

    public int obtainPointsPerMeter(){
        return totalPointsPerMeter();
    }

    public double obtainTotalPoints(){
        return obtainPointsPerMeter()*this.getDistancia();
    }
}
